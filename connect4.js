...
// will keep track of if game is active so user can't drop pieces when game is over
let gameActive = true

// storage to keep track of wins for each player
let p1Wins = localStorage.getItem('p1Wins') ? parseInt(localStorage.getItem('p1Wins')) : 0
let p2Wins = localStorage.getItem('p2Wins') ? parseInt(localStorage.getItem('p2Wins')) : 0
